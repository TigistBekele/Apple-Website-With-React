...
import logo from "../Assets/images/icons/16.png";
import "./Custom.js";
  ...
  return (
    <footer className="footer-wrapper">
      <div className="container">
        ...
        <div id="theWhole" className="footer-links-wrapper row">
          <div className="links-wrapper-1 col-sm-12 col-md">
            <h6 id="firstWrapper">Shop and Learn</h6>
            <ul className="smul">
              <li>
                <a href="#">Mac</a>
              </li>
          ...
          <div className="links-wrapper-2 col-sm-12 col-md">
            <div>
              <h6 id="secondWrapper">Services</h6>
              <ul className="smul2">
                <li>
          ...
          <div className="links-wrapper-3 col-sm-12 col-md">
            <h6 id="thirdWrapper">Apple Store</h6>
            <ul className="smul4">
              <li>
          ...
          <div className="links-wrapper-4 col-sm-12 col-md">
            <div>
              <h6 id="fourthWrapper">For Business</h6>
              <ul className="smul5">
                <li>
            ...
            <div>
              <h6 id="sixthWrapper">For Healthcare</h6>
              <ul className="smul7">
                <li>
                  <a href="#">Manage Your Apple ID</a>
                </li>
            ...
            <div>
              <h6 id="seventhWrapper">For Government</h6>
              <ul className="smul8">
                <li>
                  <a href="#">Apple and Education</a>
                </li>
          ...
          <div className="links-wrapper-5 col-sm-12 col-md">
            <div>
              <h6 id="eightWrapper">Apple Values</h6>
              <ul className="smul9">
                <li>
                  <a href="#">Find a Store</a>
                </li>
            ...
            <div>
              <h6 id="nineWrapper">About Apple</h6>
              <ul className="smul10">
                <li>
                  <a href="#">Find a Store</a>
                </li>
